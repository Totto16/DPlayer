...
(function (root, factory) {
  ...
  const Avi = (function() {
    ...
    Avi.prototype._read = function() {
      ...
      const _io__raw_data = new KaitaiStream(this._raw_data);
      this.data = new Blocks(_io__raw_data, this, this._root);
    };

    const ListBody = Avi.ListBody = (function() {
    ...
    const AvihBody = Avi.AvihBody = (function() {
    ...
    const StrfBody = Avi.StrfBody = (function() {
